  ...
  return (
    <div className='about'>
        <div className="container">
          ...
          <p>The Defi protocol system empowers developers, liquidity providers, and  traders to participate in a financial marketplace that is open and accessible to all.</p>c
        ...
        <a href="/" className="btn">Use Defi</a>8
    </div>
  )
}
